...
void
output_tar_child::changed_size(void)
{
    sub_context_ty sc;
    sc.var_set_format
    (
...
nstring
output_tar_child::filename(void)
    const
{
...
long
output_tar_child::ftell_inner(void)
    const
{
    return pos;
}
...
void
output_tar_child::end_of_line_inner(void)
{
...
nstring
output_tar_child::type_name(void)
    const
{
    return ("tar child > " + deeper->type_name());
}
