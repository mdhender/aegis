...
static rpt_value_ty *lt_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
lt_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
	...
	default:
		...
		s =
			...
			(
				scp,
				i18n("illegal comparison ($name1 < $name2)")
			);
...
static rpt_value_ty *le_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
le_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *gt_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
gt_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *ge_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
ge_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *eq_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
eq_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *ne_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
ne_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
