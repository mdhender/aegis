...
#include <aefind/cmdline.yacc.h> // must be last
...
static arglex_table_ty argtab[] =
{
    ...
    { "-REMove", arglex_token_delete, },
    { "-Size", arglex_token_size, },
    { "-Type", arglex_token_type, },
    { "-unlink", arglex_token_delete, },
    { ".EQ.", arglex_token_eq, },
    { ".GE", arglex_token_ge, },
    { ".GT.", arglex_token_gt, },
    { ".LE.", arglex_token_le, },
...
{
    nstring msg1 = message;
    nstring msg2 =  msg1.replace("$", "$$");
    // this function is for yacc
    cmdline_lex_error(0, msg2.c_str());
}
