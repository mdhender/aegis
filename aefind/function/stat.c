...
static rpt_value_ty *atime_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
atime_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *ctime_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
ctime_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *mtime_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
mtime_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *mode_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
mode_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *nlink_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
nlink_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *ino_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
ino_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *uid_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
uid_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *gid_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
gid_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *size_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
size_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
...
static rpt_value_ty *type_evaluate _((tree_ty *, string_ty *, struct stat *));

static rpt_value_ty *
type_evaluate(tp, path, st)
	tree_ty		*tp;
	string_ty	*path;
	struct stat	*st;
{
