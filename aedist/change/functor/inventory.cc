...
change_functor_inventory::change_functor_inventory(bool arg1, project *arg2,
    ...
    const nstring &uuid)
{
    ...
    html_encode_string(cp->version_get());
    printf("</a></td><td><tt>");
