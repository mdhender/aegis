...
# Copyright (C) 1995, 1997, 2006-2008, 2012 Peter Miller
...
# set some environment variables, in a fashion similar
# to the way that aegis.conf.d/test does it.
AEGIS_SEARCH_PATH="$here"
export AEGIS_SEARCH_PATH
EXEC_SEARCH_PATH="$here"
export EXEC_SEARCH_PATH
