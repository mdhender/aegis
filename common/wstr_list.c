...
/*
 * NAME
 *	wstring_list_destructor - free a wide string list
 *
 * SYNOPSIS
 *	void wstring_list_destructor(wstring_list_ty *wlp);
 *
 * DESCRIPTION
 *	The wstring_list_destructor function is used to free the contents of a
