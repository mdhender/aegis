...
get_project_menu(project_ty *pp, string_ty *filename, string_list_ty *modifier)
{
    ...
    printf("This item will provide you with some statistics about changes\n");
    printf("within the project.  The statistics include change causes,\n");
    printf("file activity and file types.\n");
    printf("<p>\n");
