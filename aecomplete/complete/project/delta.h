...
//
// MANIFEST: interface definition for aecomplete/complete/project/delta.c
//

#ifndef AECOMPLETE_COMPLETE_PROJECT_DELTA_H
#define AECOMPLETE_COMPLETE_PROJECT_DELTA_H
