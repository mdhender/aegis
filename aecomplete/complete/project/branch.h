...
//
// MANIFEST: interface definition for aecomplete/complete/project/branch.c
//

#ifndef AECOMPLETE_COMPLETE_PROJECT_BRANCH_H
#define AECOMPLETE_COMPLETE_PROJECT_BRANCH_H
