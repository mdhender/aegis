...
//
// MANIFEST: functions to manipulate aentus
//
...
completion_get(command_ty *cmd)
{
    ...
    //
    usage_mask = (1 << file_usage_test) | (1 << file_usage_manual_test);
    action_mask = (1 << file_action_create);
    return complete_change_file(cp, baserel, usage_mask, action_mask);
}
