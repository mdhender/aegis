...
rpt_expr_ty *rpt_expr_inc_pre(rpt_expr_ty *);
rpt_expr_ty *rpt_expr_inc_post(rpt_expr_ty *);
rpt_expr_ty *rpt_expr_dec_pre(rpt_expr_ty *);
rpt_expr_ty *rpt_expr_dec_post(rpt_expr_ty *);
