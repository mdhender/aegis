...
#ifndef AEGIS_AER_FUNC_SPLIT_H
#define AEGIS_AER_FUNC_SPLIT_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_split class is used to represent the split
  * function, callable from within the report generator.
  */
class rpt_func_split:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_split(const rpt_func_split &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_split &operator=(const rpt_func_split &);
};

#endif // AEGIS_AER_FUNC_SPLIT_H
