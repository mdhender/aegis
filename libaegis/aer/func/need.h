...
#ifndef AEGIS_AER_FUNC_NEED_H
#define AEGIS_AER_FUNC_NEED_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_need class is used to represent the need function,
...
private:
    /**
      ...
      */
    rpt_func_need(const rpt_func_need &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_need &operator=(const rpt_func_need &);
};

#endif // AEGIS_AER_FUNC_NEED_H
