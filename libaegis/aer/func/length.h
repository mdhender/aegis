...
#ifndef AEGIS_AER_FUNC_LENGTH_H
#define AEGIS_AER_FUNC_LENGTH_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_length class is used to represent the length
  * function, callable from within the report generator.
  */
class rpt_func_length:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_length(const rpt_func_length &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_length &operator=(const rpt_func_length &);
};

#endif // AEGIS_AER_FUNC_LENGTH_H
