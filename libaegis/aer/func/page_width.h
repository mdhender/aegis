...
#ifndef AEGIS_AER_FUNC_PAGE_WIDTH_H
#define AEGIS_AER_FUNC_PAGE_WIDTH_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_page_width class is used to represent the page_width
  * function, callable from within the report generator.
  */
class rpt_func_page_width:
    public rpt_func
{
public:
    /**
...
/**
  * The rpt_func_page_length class is used to represent the page_length
  * function, callable from within the report generator.
  */
class rpt_func_page_length:
    public rpt_func
{
public:
    /**
...
private:
    /**
      * The copy constructor.  Do not use.
      */
    rpt_func_page_length(const rpt_func_page_length &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_page_length &operator=(const rpt_func_page_length &);
};

#endif // AEGIS_AER_FUNC_PAGE_WIDTH_H
