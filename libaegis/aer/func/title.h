...
#ifndef AEGIS_AER_FUNC_TITLE_H
#define AEGIS_AER_FUNC_TITLE_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_title class is used to represent the title
  * function, callable from within the report generator.
  */
class rpt_func_title:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_title(const rpt_func_title &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_title &operator=(const rpt_func_title &);
};

#endif // AEGIS_AER_FUNC_TITLE_H
