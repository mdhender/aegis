...
//	Copyright (C) 1995, 2005-2008 Peter Miller
//
...
#ifndef AEGIS_AER_FUNC_SUBSTR_H
#define AEGIS_AER_FUNC_SUBSTR_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_substr class is used to represent the substr
  * function, callable from within the report generator.
  */
class rpt_func_substr:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_substr(const rpt_func_substr &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_substr &operator=(const rpt_func_substr &);
};

#endif // AEGIS_AER_FUNC_SUBSTR_H
