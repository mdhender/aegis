...
#ifndef AEGIS_AER_FUNC_TERSE_H
#define AEGIS_AER_FUNC_TERSE_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_terse class is used to represent the terse
  * function, callable from within the report generator.
  */
class rpt_func_terse:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_terse(const rpt_func_terse &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_terse &operator=(const rpt_func_terse &);
};

#endif // AEGIS_AER_FUNC_TERSE_H
