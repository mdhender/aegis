...
#ifndef AEGIS_AER_FUNC_TYPEOF_H
#define AEGIS_AER_FUNC_TYPEOF_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_typeof class is used to represent the typeof
  * function, callable from within the report generator.
  */
class rpt_func_typeof:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_typeof(const rpt_func_typeof &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_typeof &operator=(const rpt_func_typeof &);
};

#endif // AEGIS_AER_FUNC_TYPEOF_H
