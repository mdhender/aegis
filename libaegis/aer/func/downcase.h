...
#ifndef LIBAEGIS_AER_FUNC_DOWNCASE_H
#define LIBAEGIS_AER_FUNC_DOWNCASE_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_downcase class is used to represent the downcase
  * function, callable from within the report generator.
  */
class rpt_func_downcase:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_downcase(const rpt_func_downcase &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_downcase &operator=(const rpt_func_downcase &);
};

#endif // LIBAEGIS_AER_FUNC_DOWNCASE_H
