...
#ifndef AEGIS_AER_FUNC_MEMBERS_H
#define AEGIS_AER_FUNC_MEMBERS_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_keys class is used to represent the keys
...
private:
    /**
      ...
      */
    rpt_func_keys(const rpt_func_keys &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_keys &operator=(const rpt_func_keys &);
};

#endif // AEGIS_AER_FUNC_MEMBERS_H
