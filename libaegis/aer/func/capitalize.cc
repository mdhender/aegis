...
rpt_func_capitalize::~rpt_func_capitalize()
{
}
...
{
    return pointer(new rpt_func_capitalize());
}


const char *
rpt_func_capitalize::name()
    const
{
    return "capitalize";
}
...
bool
rpt_func_capitalize::optimizable()
    const
{
    return true;
}
...
bool
rpt_func_capitalize::verify(const rpt_expr::pointer &ep)
    const
{
...
rpt_value::pointer
rpt_func_capitalize::run(const rpt_expr::pointer &ep, size_t,
    rpt_value::pointer *argv) const
{
    ...
    {
        sub_context_ty sc;
        sc.var_set_charstar("Function", "capitalize");
