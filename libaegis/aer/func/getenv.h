...
#ifndef AEGIS_AER_FUNC_GETENV_H
#define AEGIS_AER_FUNC_GETENV_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_getenv class is used to represent the getenv function,
  * callable from within the report generator.
  */
class rpt_func_getenv:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_getenv(const rpt_func_getenv &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_getenv &operator=(const rpt_func_getenv &);
};
