...
#ifndef LIBAEGIS_AER_FUNC_UPCASE_H
#define LIBAEGIS_AER_FUNC_UPCASE_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_upcase class is used to represent the upcase
  * function, callable from within the report generator.
  */
class rpt_func_upcase:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_upcase(const rpt_func_upcase &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_upcase &operator=(const rpt_func_upcase &);
};

#endif // LIBAEGIS_AER_FUNC_UPCASE_H
