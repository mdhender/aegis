...
#ifndef AEGIS_AER_FUNC_MTIME_H
#define AEGIS_AER_FUNC_MTIME_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_mtime class is used to represent the mtime
  * function, callable from within the report generator.
  */
class rpt_func_mtime:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_mtime(const rpt_func_mtime &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_mtime &operator=(const rpt_func_mtime &);
};

#endif // AEGIS_AER_FUNC_MTIME_H
