...
#ifndef AEGIS_AER_FUNC_COLUMNS_H
#define AEGIS_AER_FUNC_COLUMNS_H

#include <libaegis/aer/func.h>


/**
  * The rpt_func_columns class is used to represent the columns
  * function, callable from within the report generator.
  */
class rpt_func_columns:
    public rpt_func
{
public:
    /**
...
private:
    /**
      ...
      */
    rpt_func_columns(const rpt_func_columns &);

    /**
      * The assignment operator.  Do not use.
      */
    rpt_func_columns &operator=(const rpt_func_columns &);
};

#endif // AEGIS_AER_FUNC_COLUMNS_H
