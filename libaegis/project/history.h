...
time_t project_history_delta_to_timestamp _((project_ty *, long));
long project_history_timestamp_to_delta _((project_ty *, time_t));
long project_history_delta_latest _((project_ty *));
long project_history_delta_by_name _((project_ty *, string_ty *, int));
long project_history_change_by_name _((project_ty *, string_ty *, int));
long project_history_change_by_timestamp _((project_ty *, time_t));
long project_history_change_by_delta _((project_ty *, long));
