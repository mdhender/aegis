...
//
// MANIFEST: interface of the xml_node_rss_generic class
//

#ifndef LIBAEGIS_XML_NODE_RSS_GENERIC_H
#define LIBAEGIS_XML_NODE_RSS_GENERIC_H

#pragma interface "xml_node_rss_generic"
...
public:
     ...
     */
    xml_node_rss_generic(xml_text_reader_by_node &reader, output_ty *out);
