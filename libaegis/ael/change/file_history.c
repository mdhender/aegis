...
static string_ty *change_brief_description_get _((change_ty *));

static string_ty *
change_brief_description_get(cp)
	change_ty	*cp;
{
	cstate		cstate_data;
...
static int change_is_completed _((change_ty *));
...
void
list_change_file_history(project_name, change_number)
