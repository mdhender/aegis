...
void
os_mkdir(const nstring &path, int mode, bool eexist_ok)
{
...
void
os_mkdir(string_ty *path, int mode, bool eexist_ok)
{
    os_mkdir(nstring(path), mode, eexist_ok);
}
