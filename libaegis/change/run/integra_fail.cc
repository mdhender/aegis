...
void
change::run_integrate_fail_notify_command()
{
    trace(("change::run_integrate_fail_notify_command(this = %08lX)\n{\n",
	(long)this));
    ...
    string_ty *the_command = project_integrate_fail_notify_command_get(pp);
