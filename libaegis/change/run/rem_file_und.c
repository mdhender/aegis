 ...
 *
 * MANIFEST: functions to manipulate rem_file_unds
 */
...
void
change_run_remove_file_undo_command(change_ty *cp, string_list_ty *wlp,
    user_ty *up)
{
    sub_context_ty  *scp;
    pconf_ty        *pconf_data;
    ...
    the_command = pconf_data->remove_file_undo_command;
    if (!the_command)
