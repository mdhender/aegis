...
void
change::run_develop_end_notify_command()
{
    trace(("change::run_develop_end_notify_command(this = %8.8lX)\n{\n",
	(long)this));
    ...
    string_ty *the_command = project_develop_end_notify_command_get(pp);
