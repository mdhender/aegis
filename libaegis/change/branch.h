...
long change_branch_next_delta_number _((change_ty *));
...
void change_branch_review_begin_notify_command_set _((change_ty *,
	string_ty *));
string_ty *change_branch_review_begin_notify_command_get _((change_ty *));
void change_branch_review_begin_undo_notify_command_set _((change_ty *,
	string_ty *));
string_ty *change_branch_review_begin_undo_notify_command_get _((change_ty *));
