...
static arglex_table_ty argtab[] =
{
    ...
    {
	"-BAse_RElative",
	(arglex_token_ty)arglex_token_base_relative,
    },
    {
	"-BRanch",
	(arglex_token_ty)arglex_token_branch,
    },
    {
	"-Build",
    ...
    {
	"-CLEan",
	(arglex_token_ty)arglex_token_clean,
    },
    {
	"-CLOne",
    ...
    {
	"-CUrrent_RElative",
	(arglex_token_ty)arglex_token_current_relative,
    },
    {
	"-DIFference",
    ...
    {
	"-Edit_BackGround",
	(arglex_token_ty)arglex_token_edit_bg,
    },
    {
	"-File",
    ...
    {
	"-Fix_Architectures",
	(arglex_token_ty)arglex_token_fix_architecture,
    },
    {
	"-FOrce",
    ...
    {
	"-GrandParent",
	(arglex_token_ty)arglex_token_grandparent,
    },
    {
	"-GrandMother",
	(arglex_token_ty)arglex_token_grandparent,
    ...
    {
	"-MAXimum",
	(arglex_token_ty)arglex_token_maximum,
    },
    {
	"-Merge_Automatic",
	(arglex_token_ty)arglex_token_merge_automatic,
    ...
    {
	"-New_BRanch",
	(arglex_token_ty)arglex_token_new_branch,
    },
    {
	"-New_BRanch_Undo",
	(arglex_token_ty)arglex_token_new_branch_undo,
    },
    {
	"-New_Change",
	...
	(arglex_token_ty)arglex_token_symbolic_links_not,
    },
    {
	"-Only_Merge",
	(arglex_token_ty)arglex_token_merge_only,
    ...
    {
	"-SUGgest",
	(arglex_token_ty)arglex_token_suggest,
    },
    {
	"-SUGgest_Noise",
	(arglex_token_ty)arglex_token_suggest_noise,
    },
    {
	"-Verify_Symbolic_Links",
	(arglex_token_ty)arglex_token_symbolic_links,
    },
    {
	"-Tab_Width",
    ...
    {
	"-TRunk",
	(arglex_token_ty)arglex_token_trunk,
    },
    {
	"-UNChanged",
    ...
    {
	"-Wait",
	(arglex_token_ty)arglex_token_wait,
    },
    {
	"-Not_Wait",
