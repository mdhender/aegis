...
void patch_line_list_constructor _((patch_line_list_ty *));
void patch_line_list_destructor _((patch_line_list_ty *));
void patch_line_list_append _((patch_line_list_ty *, patch_line_type,
	string_ty *));
