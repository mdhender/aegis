...
lib/en/LC_MESSAGES/common.mo: lib/en/LC_MESSAGES/common.po
{TAB}$(MSGFMT) -o $@ lib/en/LC_MESSAGES/common.po

$(NLSDIR)/en/LC_MESSAGES/common.mo: .mkdir.__NLSDIR__en_LC_MESSAGES \
{TAB}{TAB}lib/en/LC_MESSAGES/common.mo
{TAB}$(INSTALL_DATA) lib/en/LC_MESSAGES/common.mo $@
...
all-i18n: lib/en/LC_MESSAGES/common.mo lib/en/LC_MESSAGES/example.mo \
{TAB}{TAB}lib/fr/LC_MESSAGES/example.mo
...
clean-i18n:
{TAB}rm -f lib/en/LC_MESSAGES/common.mo lib/en/LC_MESSAGES/example.mo
{TAB}rm -f lib/fr/LC_MESSAGES/example.mo
...
install-i18n: $(NLSDIR)/en/LC_MESSAGES/common.mo \
{TAB}{TAB}$(NLSDIR)/en/LC_MESSAGES/example.mo \
{TAB}{TAB}$(NLSDIR)/fr/LC_MESSAGES/example.mo

uninstall:
{TAB}rm -f $(NLSDIR)/en/LC_MESSAGES/common.mo
