...
TEST_SUBJECT="aemakegen, vs uudecode"
...
aegis -nf \
        ...
        $work/${AEGIS_PROJECT}.C010/datadir/pic.jpg.uue \
...
datadir/pic.jpg: datadir/pic.jpg.uue
{TAB}uudecode -o $@ datadir/pic.jpg.uue

$(datadir)/projname/pic.jpg: .mkdir.__datadir__projname datadir/pic.jpg
{TAB}$(INSTALL_DATA) datadir/pic.jpg $@
...
install-datadir: $(datadir)/projname/pic.jpg

uninstall:
{TAB}rm -f $(bindir)/example $(datadir)/projname/pic.jpg
...
datadir/pic.jpg: datadir/pic.jpg.uue
{TAB}uudecode -o datadir/pic.jpg datadir/pic.jpg.uue

# executables to be installed
bin_PROGRAMS = bin/example

# Data files to be installed in $(datadir)/projname/
dist_pkgdatadir_DATA = pic.jpg

# The example program.
bin_example_SOURCES = example/main.c
