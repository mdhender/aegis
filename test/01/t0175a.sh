...
#
activity="copy file 947"
aegis -cp $work/devdir -rescind -delta 2 -nl > log 2>&1
if test $? -ne 0 ; then cat log; fail; fi

activity="check change file state 951"
cat > ok << 'end'
src =
[
        {
