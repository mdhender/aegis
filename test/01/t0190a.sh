...
#
# MANIFEST: Test the aecvsserver update functionality
#
...
activity="develop end 330"
$bin/aegis -de 3 > log 2>&1
if test $? -ne 0 ; then cat log; no_result; fi

activity="review pass 334"
