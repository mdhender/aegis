...
# add files to the change
#
activity="make transparent 401"
$bin/aegis -mt $workchan/bogus -nl > log 2>&1
if test $? -ne 0 ; then cat log; fail; fi

activity="check file contents 405"
cat > ok << 'end'
the trunk version
end
if test $? -ne 0 ; then no_result; fi
...
activity="check change file state 414"
cat > ok << 'end'
src =
[
        {
...
activity="check change state 464"
cat > ok << 'end'
brief_description = "The third change";
...
activity="check change state 515"
cat > ok << 'end'
brief_description = "The third change";
description = "The third change";
cause = internal_bug;
...
# develop end
#
activity="develop end 596"
$bin/aegis -de > log 2>&1
if test $? -ne 0 ; then cat log; fail; fi

activity="check change file state 600"
cat > ok << 'end'
src =
[
        {
...
activity="check change state 634"
cat > ok << 'end'
brief_description = "The third change";
description = "The third change";
cause = internal_bug;
...
activity="check branch file state 683"
cat > ok << 'end'
src =
[
        {
...
# pass the integration
#
activity="integrate pass 755"
$bin/aegis -intpass -nl > log 2>&1
if test $? -ne 0 ; then cat log; no_result; fi

activity="check change file state 759"
cat > ok << 'end'
src =
[
        {
...
activity="check change state 781"
cat > ok << 'end'
brief_description = "The third change";
description = "The third change";
cause = internal_bug;
...
activity="check branch file state 850"
cat > ok << 'end'
src =
[
        {
...
# develop end
#
activity="develop end 888"
$bin/aegis -de 2 > log 2>&1
if test $? -ne 0 ; then cat log; fail; fi

activity="check change file state 892"
cat > ok << 'end'
src =
[
        {
...
activity="check change state 920"
cat > ok << 'end'
...
activity="check trunk file state 1027"
cat > ok << 'end'
src =
[
        {
...
# pass the integration
#
activity="integrate pass 1109"
$bin/aegis -intpass -nl 2 > log 2>&1
if test $? -ne 0 ; then cat log; no_result; fi

activity="check change file state 1113"
cat > ok << 'end'
src =
[
        {
...
activity="check change state 1141"
cat > ok << 'end'
brief_description = "A bogus project created to test the aemt functionality, branch 2.";
description = "A bogus project created to test the aemt functionality, branch 2.";
cause = internal_enhancement;
...
activity="check trunk file state 1262"
cat > ok << 'end'
src =
[
        {
