...
public:
    ...
    */
    ...
    /**
    * The fred_set method is used to set the value of the #fred instance
    * variable, and record that it has been set.
    */
    void fred_set(const nstring &value);

    /**
    * The fred_clear method is used to reset the the #fred instance
    * variable to its default value, and record that it is no longer set.
    */
    void fred_clear();
...
void
test::fred_set(const nstring &value_)
{
    fred = value_;
}
...
{
    return introspector_nstring::create(fred);
}
...
{
    trace(("%s\n{\n", __PRETTY_FUNCTION__));
    introspector_nstring::write(fp, "fred", fred, false);
    trace(("}\n"));
}
    ...
    const
{
    trace(("%s\n{\n", __PRETTY_FUNCTION__));
    fp->fputs("<test>\n");
    introspector_nstring::write_xml(fp, "fred", fred);
    fp->fputs("</test>\n");
    trace(("}\n"));
}
