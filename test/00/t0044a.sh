...
#
# MANIFEST: Test the aenfu directory functionality
#
...
$bin/aegis -nf $work/test.C010/config $work/test.C010/a \
...
activity="new file undo 176"
$bin/aegis -nfu $work/test.C010/c -v > log 2>&1
if test $? -ne 0 ; then cat log; fail; fi

activity="check change file state 180"
cat > ok << 'fubar'
src =
[
	{
