...
#       Copyright (C) 1996-1998, 2000, 2002-2008, 2012 Peter Miller
#
...
#
activity="check change state 189"
cat > ok << 'fubar'
brief_description = "one";
description = "one";
...
activity="check change file state 225"
cat > ok << 'fubar'
src =
[
        {
