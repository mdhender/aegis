...
#
$bin/aegis -nrls -l -v -lib $worklib
if test $? -ne 0 ; then fail; fi
$bin/aegis -nrls -v foo -dir $workproj2 -lib $worklib -nl
if test $? -ne 0 ; then fail; fi
ls -lRA $workproj2
cat $workproj2/info/change/0/001
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/state
if test $? -ne 0 ; then fail; fi
ls -lgRA $worklib
$bin/aegis -nrls -l -v -lib $worklib
if test $? -ne 0 ; then fail; fi
...
$bin/aegis -new_change -f $tmp -project foo.1.1 -v -lib $worklib
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/change/0/002
if test $? -ne 0 ; then fail; fi

#
# start work on change 2 of foo.1.1
#
$bin/aegis -devbeg 2 -p foo.1.1 -v -dir $workchan -lib $worklib
if test $? -ne 0 ; then fail; fi

#
# copy a file into the change
#
$bin/aegis -cp $workchan/main.c -v -nl -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/change/0/002
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/state
if test $? -ne 0 ; then fail; fi
cat $worklib/user/$USER
if test $? -ne 0 ; then fail; fi
ls -lRA $work
...
# need another test
#
$bin/aegis -nt -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
...
# test the change
#
$bin/aegis -b -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -diff -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -test -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -test -bl -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
cat $workchan/main.c,D
if test $? -ne 0 ; then fail; fi
...
# start integrating
#
$bin/aegis -devend -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -revpass -v -c 2 -p foo.1.1 -lib $worklib
if test $? -ne 0 ; then fail; fi
$bin/aegis -intbeg -v -c 2 -p foo.1.1 -lib $worklib
if test $? -ne 0 ; then fail; fi
...
$bin/aegis -b -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -t -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
$bin/aegis -t -bl -nl -v -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
...
#
$bin/aegis -intpass -nl -lib $worklib -p foo.1.1
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/change/0/002
if test $? -ne 0 ; then fail; fi
cat $workproj2/info/state
...
if test $? -ne 0 ; then fail; fi
ls -lR $work
$bin/aegis -l projhist -v -p foo.1.1 -lib $worklib
if test $? -ne 0 ; then fail; fi
