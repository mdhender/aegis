...
#       Copyright (C) 1999, 2000, 2002, 2004-2008, 2012 Peter Miller
#       Copyright (C) 2005, 2010 Walter Franzini
#
...
#
activity="working directory 142"
mkdir $work $work/lib
if test $? -ne 0 ; then no_result; fi
chmod 777 $work/lib
if test $? -ne 0 ; then no_result; fi
...
#
activity="extract the archive 272"
...
#
activity="check the archive structure 301"
...
activity="etc/change-number 328"
cat > $work/test.ok <<'EOF'
1
EOF
if test $? -ne 0; then no_result; fi
...
check_it $work/test.ok $work/test.d/etc/change-set

#
# Check the archive contents
#
activity="check the archive contents 368"
...
then
    ...
    # Check the aedist archive
    #
    activity="extract the archive 394"
    ...
    # Check the archive structure
    #
    activity="check the archive structure 406"
    cat > $work/test.ok <<EOF
