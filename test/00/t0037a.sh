...
#
# MANIFEST: Test the progress messages functionality
#
...
#
# those test will be the same as the first one
#
cp $workchan/test/00/t0001a.sh $workchan/test/00/t0002a.sh
if test $? -ne 0 ; then no_result; fi

cp $workchan/test/00/t0001a.sh $workchan/test/00/t0003a.sh
if test $? -ne 0 ; then no_result; fi
...
aegis: project "foo": change 10: test 2 of 3
aegis: project "foo": change 10: test/00/t0002a.sh pass
aegis: project "foo": change 10: test 3 of 3
