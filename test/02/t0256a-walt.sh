...
#	foo
#
activity="create the 1st change 225"
cat > caf <<EOF
...
#
activity="copy files 517"
$bin/aegis -cp 100 -delta 1 $workchan -nl -v > log 2>&1
if test $? -ne 0; then cat log; no_result; fi

activity="check fstate 521"
cat > ok <<EOF
src =
[
	{
