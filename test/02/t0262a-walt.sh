...
activity="create the branch 208"
$bin/aegis -nbr -p $AEGIS_PROJECT 1 -v > log 2>&1
if test $? -ne 0; then cat log; no_result; fi
...
#	aegis.conf
#
activity="create the 1st change 221"
cat > caf <<EOF
