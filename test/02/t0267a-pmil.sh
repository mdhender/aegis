...
TEST_SUBJECT="aemakegen vs i18n"

# load up standard prelude and test functions
. test_funcs

AEGIS_PROJECT=testing
...
aegis -nf \
    ...
    $work/${AEGIS_PROJECT}.C010/en/LC_MESSAGES/fred.po \
...
en/LC_MESSAGES/fred.mo: en/LC_MESSAGES/fred.po
{TAB}$(MSGFMT) -o $@ en/LC_MESSAGES/fred.po

$(NLSDIR)/en/LC_MESSAGES/fred.mo: .mkdir.__NLSDIR__en_LC_MESSAGES \
{TAB}{TAB}en/LC_MESSAGES/fred.mo
{TAB}$(INSTALL_DATA) en/LC_MESSAGES/fred.mo $@
...
all-i18n: en/LC_MESSAGES/fred.mo
...
clean-i18n:
{TAB}rm -f en/LC_MESSAGES/fred.mo
...
install-i18n: $(NLSDIR)/en/LC_MESSAGES/fred.mo

uninstall:
{TAB}rm -f $(NLSDIR)/en/LC_MESSAGES/fred.mo $(bindir)/fred
...
activity="check control 341"
diff makefile.ok ${AEGIS_PROJECT}.C010/Makefile.in
if test $? -ne 0 ; then fail; fi
