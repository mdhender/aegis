...
#
# test the aedist -rec functionality
#
AEGIS_PATH=$work/lib
export AEGIS_PATH

activity="new project 174"
...
activity="project attributes 182"
cat > paf << fubar
...
activity="set the change's UUID 248"
...
development_directory = ".../change-dir";
history =
[
	{
		when = TIME;
...
check_it ok $work/proj.dir/info/change/0/011
