...
TEST_SUBJECT="aemakegen, uudecode *.uue files"
...
aegis -nf $work/${AEGIS_PROJECT}.C010/aegis.conf \
    ...
    $work/${AEGIS_PROJECT}.C010/fred/something.c.uue \
    > log 2>&1
if test $? -ne 0 ; then cat log; no_result; fi
...
fred/something.c: bin/test_base64 fred/something.c.uue
{TAB}bin/test_base64 -uu -i -nh fred/something.c.uue $@
...
clean-misc:
{TAB}rm -f .bin .mkdir.__bindir_ core fred/something.c
