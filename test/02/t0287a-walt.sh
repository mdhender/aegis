...
check_it ok $work/proj/info/change/0/001.branch/0/001.fs

#
# create a new change in the same branch
#
...
check_it ok $work/proj/info/change/0/001.branch/0/002.fs
...
cat > cattr << 'end'
brief_description = "Another change.";
cause = internal_enhancement;
end
test $? -eq 0 || no_result
...
aegis -dev-begin 3 -dir $work/dd3
test $? -eq 0 || no_result

activity="config file 258"
aegis -new-file $work/dd3/aegis.conf -nl
test $? -eq 0 || no_result

activity="source file 262"
aegis -new-file $work/dd3/barney -nl
test $? -eq 0 || no_result

activity="test file 266"
aegis -new-test $work/dd3/test.sh -nl
test $? -eq 0 || no_result
...
check_it ok $work/proj/info/change/0/002.branch/0/003.fs
