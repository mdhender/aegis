...
TEST_SUBJECT="aemakegen, vs fmtgen"
...
aegis -nf \
        ...
        $work/${AEGIS_PROJECT}.C010/aegis/example.def \
        -v > log 2>&1
if test $? -ne 0 ; then cat log; no_result; fi
...
aegis/example.fmtgen.cc aegis/example.fmtgen.h: aegis/example.def bin/fmtgen
{TAB}bin/fmtgen -I. aegis/example.def aegis/example.fmtgen.cc \
{TAB}{TAB}aegis/example.fmtgen.h

aegis/example.fmtgen.o: aegis/example.fmtgen.cc
{TAB}$(CXX) $(CPPFLAGS) $(CXXFLAGS) -I. -c aegis/example.fmtgen.cc
{TAB}mv example.fmtgen.o $@
...
# The aegis program.
#
aegis_obj = aegis/example.fmtgen.o aegis/main.o
...
clean-obj:
{TAB}rm -f aegis/example.fmtgen.cc aegis/example.fmtgen.h
{TAB}rm -f aegis/example.fmtgen.o aegis/main.o
...
# The aegis program.
bin_aegis_SOURCES = aegis/example.def aegis/example.fmtgen.cc aegis/main.cc
...
EXTRA_DIST = aegis.conf aegis/example.fmtgen.h configure.ac

# Catch-22 when building dependencies.
BUILT_SOURCES = aegis/example.fmtgen.cc aegis/example.fmtgen.h
