...
main(int argc, char **argv)
{
    ...
    for (size_t j = 0; ; ++j)
    {
        ...
        // Note: this particular logic must be identical to the logic
        // used in the libaegis/ael/project/files.cc file, since this is
        // simply meant to be a more efficient version of that code.
        if (cid.set() && cid.get_cp()->file_find(src, view_path_first))
            continue;
