...
#ifndef FMTGEN_TYPE_STRUCTURE_INTROSP_CODE_H
#define FMTGEN_TYPE_STRUCTURE_INTROSP_CODE_H

#include <fmtgen/type/structure.h>

/**
  * The type_structure_code class is used to represent the code
  * generation necessary for a structure type, in the C++ OO style.
  */
class type_structure_introspector_code:
...
public:
    /**
      * The destructor.
      */
    virtual ~type_structure_introspector_code();
...
private:
    /**
      ...
      */
    type_structure_introspector_code(generator *gen, const nstring &name,
        bool global);
...
private:
    /**
      ...
      */
    type_structure_introspector_code();

    /**
      * The copy constructor.  Do not use.
      */
    type_structure_introspector_code(const type_structure_introspector_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_structure_introspector_code &operator=(
        const type_structure_introspector_code &);
};

#endif // FMTGEN_TYPE_STRUCTURE_INTROSP_CODE_H
