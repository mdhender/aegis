...
#ifndef FMTGEN_TYPE_STRING_INTROSP_CODE_H
#define FMTGEN_TYPE_STRING_INTROSP_CODE_H

#include <fmtgen/type/string.h>

/**
  * The type_string_introspector_code class is used to represent the
  * code generation needed to manage strings in the meta-data, in the
  * C++ OO introspector style, for the code files.
  */
class type_string_introspector_code:
    public type_string
{
public:
    /**
      * The destructor.
      */
    virtual ~type_string_introspector_code();
...
private:
    /**
      ...
      */
    type_string_introspector_code(generator *gen);
...
private:
    /**
      ...
      */
    type_string_introspector_code();

    /**
      * The copy constructor.  Do not use.
      */
    type_string_introspector_code(const type_string_introspector_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_string_introspector_code &operator=(
        const type_string_introspector_code &);
};

#endif // FMTGEN_TYPE_STRING_INTROSP_CODE_H
