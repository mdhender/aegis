...
#ifndef FMTGEN_TYPE_REAL_INTROSP_CODE_H
#define FMTGEN_TYPE_REAL_INTROSP_CODE_H

#include <fmtgen/type/real.h>

/**
  * The type_real_introspector_code class is used to represent the
  * type of a field which is a real (double) value, in the C++ OO
  * introspector style.
  */
class type_real_introspector_code:
    public type_real
{
public:
    /**
      * The destructor.
      */
    virtual ~type_real_introspector_code();
...
private:
    /**
      ...
      */
    type_real_introspector_code(generator *gen);
...
private:
    /**
      ...
      */
    type_real_introspector_code();

    /**
      * The copy constructor.  Do not use.
      */
    type_real_introspector_code(const type_real_introspector_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_real_introspector_code &operator=(const type_real_introspector_code &);
};

#endif // FMTGEN_TYPE_REAL_INTROSP_CODE_H
