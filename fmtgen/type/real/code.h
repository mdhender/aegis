...
#ifndef FMTGEN_TYPE_REAL_CODE_H
#define FMTGEN_TYPE_REAL_CODE_H

#include <fmtgen/type/real.h>

/**
  * The type_real_code class is used to represent
  */
class type_real_code:
    public type_real
{
public:
    /**
...
private:
    ...
    /**
      ...
      */
    type_real_code(const type_real_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_real_code &operator=(const type_real_code &);
};

#endif // FMTGEN_TYPE_REAL_CODE_H
