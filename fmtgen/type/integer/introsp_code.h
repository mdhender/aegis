...
#ifndef FMTGEN_TYPE_INTEGER_INTROSP_CODE_H
#define FMTGEN_TYPE_INTEGER_INTROSP_CODE_H

#include <fmtgen/type/integer.h>

/**
  * The type_integer_introspector_code class is used to represent the
  * code generation necassary to manage integer (long) members, in the
  * C++ OO introspector style.
  */
class type_integer_introspector_code:
    public type_integer
{
public:
    /**
      * The destructor.
      */
    virtual ~type_integer_introspector_code();
...
private:
    /**
      ...
      */
    type_integer_introspector_code(generator *gen);
...
private:
    /**
      ...
      */
    type_integer_introspector_code();

    /**
      * The copy constructor.  Do not use.
      */
    type_integer_introspector_code(const type_integer_introspector_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_integer_introspector_code &operator=(
        const type_integer_introspector_code &);
};

#endif // FMTGEN_TYPE_INTEGER_INTROSP_CODE_H
