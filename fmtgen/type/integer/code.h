...
#ifndef FMTGEN_TYPE_INTEGER_CODE_H
#define FMTGEN_TYPE_INTEGER_CODE_H

#include <fmtgen/type/integer.h>

/**
  * The type_integer_code class is used to represent the code generation
  * necassary to manage integer (long) members, in the original (circa
  * 1991) C style.
  */
class type_integer_code:
    public type_integer
{
public:
    /**
...
private:
    /**
      ...
      */
    type_integer_code(generator *gen);
...
private:
    ...
    /**
      ...
      */
    type_integer_code(const type_integer_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_integer_code &operator=(const type_integer_code &);
};

#endif // FMTGEN_TYPE_INTEGER_CODE_H
