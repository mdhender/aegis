...
#ifndef FMTGEN_TYPE_LIST_CODE_H
#define FMTGEN_TYPE_LIST_CODE_H

#include <fmtgen/type/list.h>

/**
  * The type_list_code class is used to represent the code generation
  * for the code file for meta-data which is a list of some other type,
  * in the C (1991) style.
  */
class type_list_code:
    public type_list
{
public:
    /**
...
private:
    /**
      ...
      */
    type_list_code(generator *gen, const nstring &a_name, bool global,
...
private:
    ...
    /**
      ...
      */
    type_list_code(const type_list_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_list_code &operator=(const type_list_code &);
};

#endif // FMTGEN_TYPE_LIST_CODE_H
