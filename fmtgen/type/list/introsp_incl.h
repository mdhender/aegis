...
#ifndef FMTGEN_TYPE_LIST_INTROSP_INCL_H
#define FMTGEN_TYPE_LIST_INTROSP_INCL_H

#include <fmtgen/type/list.h>

/**
  * The type_list_introspector_include class is used to represent the
  * code generation for the include file for meta-data which is a list
  * of some other type, in the C++ OO introspector style.
  */
class type_list_introspector_include:
    public type_list
{
public:
    /**
      * The destructor.
      */
    virtual ~type_list_introspector_include();
...
private:
    /**
      ...
      */
    type_list_introspector_include(generator *gen, const nstring &a_name,
...
private:
    /**
      ...
      */
    type_list_introspector_include();

    /**
      * The copy constructor.  Do not use.
      */
    type_list_introspector_include(const type_list_introspector_include &);

    /**
      * The assignment operator.  Do not use.
      */
    type_list_introspector_include &operator=(
        const type_list_introspector_include &);
};

#endif // FMTGEN_TYPE_LIST_INTROSP_INCL_H
