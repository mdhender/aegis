...
type_time_introspector_include::~type_time_introspector_include()
{
    trace(("%s\n", __PRETTY_FUNCTION__));
}
...
type::pointer
type_time_introspector_include::create(generator *gen)
{
    trace(("%s\n", __PRETTY_FUNCTION__));
    return pointer(new type_time_introspector_include(gen));
}


void
type_time_introspector_include::gen_body()
    const
{
    trace(("%s\n", __PRETTY_FUNCTION__));
...
void
type_time_introspector_include::gen_declarator(const nstring &variable_name,
