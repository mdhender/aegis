...
#ifndef FMTGEN_TYPE_TIME_INTROSP_CODE_H
#define FMTGEN_TYPE_TIME_INTROSP_CODE_H

#include <fmtgen/type/time.h>

/**
  * The type_time_introspector_code class is used to represent the
  * type of a field which is a time (time_t) value, in the C++ OO
  * introspector style.
  */
class type_time_introspector_code:
    public type_time
{
public:
    /**
      * The destructor.
      */
    virtual ~type_time_introspector_code();
...
private:
    /**
      ...
      */
    type_time_introspector_code(generator *gen);
...
private:
    /**
      ...
      */
    type_time_introspector_code();

    /**
      * The copy constructor.  Do not use.
      */
    type_time_introspector_code(const type_time_introspector_code &);

    /**
      * The assignment operator.  Do not use.
      */
    type_time_introspector_code &operator=(const type_time_introspector_code &);
};

#endif // FMTGEN_TYPE_TIME_INTROSP_CODE_H
