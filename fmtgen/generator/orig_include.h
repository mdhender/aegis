...
#ifndef FMTGEN_GENERATOR_ORIG_INCLUDE_H
#define FMTGEN_GENERATOR_ORIG_INCLUDE_H

#include <fmtgen/generator.h>

/**
  * The generator_original_include class is used to represent the code
  * generator in the original (circa 1991) format, which was C with some
  * helpers.  This is the include (.h) half.
  */
class generator_original_include:
    public generator
{
public:
    /**
      * The destructor.
      */
    virtual ~generator_original_include();
...
private:
    /**
      ...
      */
    generator_original_include(const nstring &filename);
...
private:
    /**
      ...
      */
    generator_original_include();

    /**
      * The copy constructor.  Do not use.
      */
    generator_original_include(const generator_original_include &);

    /**
      * The assignment operator.  Do not use.
      */
    generator_original_include &operator=(const generator_original_include &);
};

#endif // FMTGEN_GENERATOR_ORIG_INCLUDE_H
