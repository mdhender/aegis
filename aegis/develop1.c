 ...
 *
 * MANIFEST: functions to add and remove developers
 */
...
static void developer_list _((void (*)(void)));
...
new_developer()
{
	...
	case arglex_token_list:
		developer_list(new_developer_usage);
		break;
	}
	trace((/*{*/"}\n"));
}
...
remove_developer_help()
{
	...
	{
"NAME",
"	%s -Remove_Developer - remove developers from a",
"	project",
"",
"SYNOPSIS",
"	%s -Remove_Developer <user-name>... [ <option>... ]",
"	%s -Remove_Developer -List [ <option>... ]",
"	%s -Remove_Developer -Help",
"",
"DESCRIPTION",
"	The %s -Remove_Developer command is used to remove",
...
remove_developer()
{
	...
	case arglex_token_list:
		developer_list(remove_developer_usage);
		break;
	}
	trace((/*{*/"}\n"));
}
