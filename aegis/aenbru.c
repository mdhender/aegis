...
new_branch_undo_usage()
{
	...
	fprintf(stderr, "usage: %s -New_Branch_Undo <change_number> [ <option>... ]\n", progname);
	fprintf(stderr, "       %s -New_Branch_Undo -List [ <option>... ]\n", progname);
...
new_branch_undo_list()
{
	...
	while (arglex_token != arglex_token_eoln)
	{
		...
		case arglex_token_string:
			if (project_name)
				duplicate_option_by_name(arglex_token_project, new_branch_undo_usage);
...
new_branch_undo_main()
{
	...
	while (arglex_token != arglex_token_eoln)
	{
		...
		case arglex_token_number:
			if (change_number)
				duplicate_option_by_name(arglex_token_change, new_branch_undo_usage);
